...
# For MOCOGAN Only
_C.MODEL.VIDEO_LENGTH = 16
_C.MODEL.DIM_Z_CONTENT = 50
_C.MODEL.DIM_Z_MOTION = 10
_C.MODEL.DIM_Z_CATEGORY = 0
_C.MODEL.USE_NOISE = True
_C.MODEL.NOISE_SIGMA = 0.1
_C.MODEL.VIDEO_LENGTH = 16
...
_C.LOG.LOG_EPOCH = 1
_C.LOG.MODEL_SAVE_PATH = '../drive/MyDrive/Log/save_models'
_C.LOG.MODEL_SAVE_EPOCH = 500
_C.LOG.SAMPLE_PATH = '../drive/MyDrive/Log/samples'
_C.LOG.SAMPLE_EPOCH = 500
